namespace Utterance
{
    ...
    public class ExpressionEqualityComparer : IEqualityComparer<Expression>
    {
        ...
        public static IEqualityComparer<Expression> Default
        {
            get
            {
                if (_default == null) _default = new ExpressionEqualityComparer();
                return _default;
            }
        }

        public bool RequirePropertyNameEquivalence { get; protected set; }
        ...
        protected HashCodeExpressionVisitor HashCodeVisitor
        {
            get
            {
                if (_hashCodeVisitor == null) _hashCodeVisitor = new HashCodeExpressionVisitor();

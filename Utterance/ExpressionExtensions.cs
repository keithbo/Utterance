namespace Utterance
{
    ...
    public static class ExpressionExtensions
    {
        ...
        {
            return new SubtreeEvaluator(new Nominator(canEvaluate ?? DefaultPartialEvalPredicate).Nominate(source))
                .Eval(source);
        }
        ...
        /// <param name="expression">Expression tree to replace in</param>
        /// <param name="pairs">
        ///     Expression pairs stored in Tuple form, first value is the search expression,
        ///     second value is the replace expression
        /// </param>

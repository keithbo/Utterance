namespace Utterance
{
    ...
    public static class LambdaExpressionExtensions
    {
        ...
        /// <returns></returns>
        public static Expression<Func<TResult>> Compose<TIntermediate, TResult>(
            this Expression<Func<TIntermediate>> first, Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static Expression<Func<T1, TResult>> Compose<T1, TIntermediate, TResult>(
            this Expression<Func<T1, TIntermediate>> first, Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static Expression<Func<T1, T2, TResult>> Compose<T1, T2, TIntermediate, TResult>(
            this Expression<Func<T1, T2, TIntermediate>> first, Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static Expression<Func<T1, T2, T3, TResult>> Compose<T1, T2, T3, TIntermediate, TResult>(
            this Expression<Func<T1, T2, T3, TIntermediate>> first, Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static Expression<Func<T1, T2, T3, T4, TResult>> Compose<T1, T2, T3, T4, TIntermediate, TResult>(
            this Expression<Func<T1, T2, T3, T4, TIntermediate>> first, Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        /// <param name="second"></param>
        /// <returns></returns>
        public static Expression<Func<T1, T2, T3, T4, T5, TResult>> Compose<T1, T2, T3, T4, T5, TIntermediate, TResult>(
            this Expression<Func<T1, T2, T3, T4, T5, TIntermediate>> first,
        ...
        public static Expression<Func<T1, T2, T3, T4, T5, T6, TResult>>
            Compose<T1, T2, T3, T4, T5, T6, TIntermediate, TResult>(
                this Expression<Func<T1, T2, T3, T4, T5, T6, TIntermediate>> first,
                Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        public static Expression<Func<T1, T2, T3, T4, T5, T6, T7, TResult>>
            Compose<T1, T2, T3, T4, T5, T6, T7, TIntermediate, TResult>(
                this Expression<Func<T1, T2, T3, T4, T5, T6, T7, TIntermediate>> first,
                Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        public static Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult>>
            Compose<T1, T2, T3, T4, T5, T6, T7, T8, TIntermediate, TResult>(
                this Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, TIntermediate>> first,
                Expression<Func<TIntermediate, TResult>> second)
        {
        ...
        {
            var paramStack = new Stack<Expression>(parameters.Reverse());

            if (first.Parameters.Count > paramStack.Count) throw new InvalidOperationException();
            ...
            if (second.Parameters.Count != paramStack.Count) throw new InvalidOperationException();
